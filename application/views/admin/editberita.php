...
<div class="container">
	<div class="col-md-8 col-md-offset-2">
		...
		<form action="<?php echo base_url().'dashboard/proseseditberita' ?>" method="post" enctype="multipart/form-data">
			<?php 
			foreach($user as $u){ 
				?>
				...
				<div class="form-group">
					<label class="label" for="namafile">Gambar Sebelumnya : <a href="<?php echo base_url().'assets/images/'.$u->gambar_berita; ?>"><?php echo $u->gambar_berita ?></a></label>
