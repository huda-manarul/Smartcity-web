...
<div class="container">
  <div class="col-md-8 col-md-offset-2">
    ...
    <form action="<?php echo base_url().'dashboard/ok1' ?>" method="post" >
      <?php 
          foreach($user as $u){ 
            ?>
      ...
      <input type="text" name="judul" value="<?php echo $u->instansi ?>" class="form-control" placeholder="Objek Pengaduan" required/><br/>
