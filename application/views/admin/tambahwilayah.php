<main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
	<div class="container">
		<div class="col-md-8 col-md-offset-2">
			...
			<form action="<?php echo base_url().'dashboard/prosestambahwilayah' ?>" method="post" enctype="multipart/form-data" >
				<input type="text" name="nama" class="form-control" placeholder="nama wilayah" required/><br/>
